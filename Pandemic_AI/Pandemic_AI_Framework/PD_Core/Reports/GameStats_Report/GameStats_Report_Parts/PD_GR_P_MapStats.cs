...
namespace Pandemic_AI_Framework
{
    public class PD_GR_P_MapStats : PD_Report_Part
    {
            ...
            )
        {
            ...
            {
                NumDiseaseCubesOnMap_Type0 += game.GQ_Num_InfectionCubes_OfType_OnCity(city, 0);
                NumDiseaseCubesOnMap_Type1 += game.GQ_Num_InfectionCubes_OfType_OnCity(city, 1);
                NumDiseaseCubesOnMap_Type2 += game.GQ_Num_InfectionCubes_OfType_OnCity(city, 2);
                NumDiseaseCubesOnMap_Type3 += game.GQ_Num_InfectionCubes_OfType_OnCity(city, 3);
            }
            ...
            foreach (var city in game.map.cities)
            {
                ...
                int numCubes_Type0 = game.GQ_Num_InfectionCubes_OfType_OnCity(
                    city,
                    0
                    );
                if (numCubes_Type0 == 1)
                ...
                int numCubes_Type1 = game.GQ_Num_InfectionCubes_OfType_OnCity(city,1);
                if (numCubes_Type1 == 1)
                {
                    NumCitiesWithOneSameTypeCube++;
                ...
                int numCubes_Type2 = PD_Game_Queries.GQ_Num_InfectionCubes_OfType_OnCity(
                    game,
                    city,
                    2
                    );
                ...
                int numCubes_Type3 = PD_Game_Queries.GQ_Num_InfectionCubes_OfType_OnCity(
                    game,
                    city,
                    3
                    );
