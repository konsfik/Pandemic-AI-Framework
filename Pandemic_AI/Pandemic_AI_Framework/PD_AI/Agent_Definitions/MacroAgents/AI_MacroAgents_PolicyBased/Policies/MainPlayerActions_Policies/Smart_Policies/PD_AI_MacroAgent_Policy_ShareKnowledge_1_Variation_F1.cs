...
{
    [Serializable]
    public class PD_AI_MacroAgent_Policy_ShareKnowledge_1_Variation_F1 : PD_AI_MacroAgent_MainPolicy_Base
    {
            ...
            )
        {
            ...
            // take position positive nextRound
            List<PD_MacroAction> takePosition_Positive_NextRound =
                PD_AI_MacroAgent_SubPolicies.TakePosition_Positive_NextRound(
                    game,
                    pathFinder,
                    allMacros
                    );
