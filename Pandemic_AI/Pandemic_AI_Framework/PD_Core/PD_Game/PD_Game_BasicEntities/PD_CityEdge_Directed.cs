...
{
    [Serializable]
    public class PD_CityEdge_Directed : ICustomDeepCopyable<PD_CityEdge_Directed>
    {
        public PD_City City1 { get; private set; }
        public PD_City City2 { get; private set; }

        public PD_CityEdge_Directed(PD_City city1, PD_City city2)
        {
            if (city1 == city2)
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            PD_CityEdge_Directed edge = (PD_CityEdge_Directed)obj;
        ...
        public PD_CityEdge_Directed GetCustomDeepCopy()
        {
            return new PD_CityEdge_Directed(
                City1.GetCustomDeepCopy(),
                City2.GetCustomDeepCopy()
                );
        }

        public static bool operator ==(PD_CityEdge_Directed edge1, PD_CityEdge_Directed edge2)
        {
